...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% order_kmeans_norm=[5,4,8,1,7,6,2,3];
% order_ng_norm=[4,3,1,8,7,2,6,5];
% order_my_norm=[7,5,2,8,4,6,1,3];
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% order_kmeans_exp=[1,7,3,4,2,5,6,8];
% order_ng_exp=[8,1,4,6,7,5,3,2];
% order_my_exp=[2,4,5,6,7,3,8,1];
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% order_kmeans_chi2=[3,1,7,8,6,2,4,5];
% order_ng_chi2=[2,6,7,1,3,5,4,8];
% order_my_chi2=[6,2,5,7,3,4,1,8];
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% order_kmeans_rayl=[5,1,3,4,2,6,7,8];
% order_ng_rayl=[6,4,2,7,1,3,8,5];
% order_my_rayl=[8,7,5,2,4,3,6,1];
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% order_kmeans_geo=[1,6,5,4,8,3,2,7];
% order_ng_geo=[7,3,1,6,4,8,5,2];
% order_my_geo=[6,4,8,7,1,5,3,2];
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
